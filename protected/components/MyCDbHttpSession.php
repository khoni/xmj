...
class MyCDbHttpSession extends CDbHttpSession {
    ...
    public function writeSession($id, $data) {
        try {
            ...
            //modified by sani iman pribadi
            /* 30 Oct 2014
             * user_id adalah field untuk menyimpan user role id yang sedang login
             */
            ...
            if (false === $db->createCommand($sql)->queryScalar($toBind)) {
                ...
                $sql .= ", `user_role_id`";
                $toBind[':user_role_id'] = $userRoleId;
                
                $sql .= ", `platform`";
                $toBind[":platform"] = Yii::app()->browser->getPlatform();
