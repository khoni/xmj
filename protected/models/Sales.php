...
class Sales extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('salesID, userID, kantorID, sales_tipeID, nama, alamat, daerahID, hp', 'required'),
			array('is_aktif', 'numerical', 'integerOnly'=>true),
			array('salesID, userID, kantorID, sales_tipeID, nama, alamat, daerahID', 'length', 'max'=>50),
			array('telepon, hp, fax, npwp, ktp, passport', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('salesID, userID, kantorID, sales_tipeID, nama, alamat, daerahID, telepon, hp, fax, npwp, ktp, passport, is_aktif', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('sales_tipeID',$this->sales_tipeID,true);
