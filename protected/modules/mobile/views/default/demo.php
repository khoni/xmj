<h3 class="page-title">Timeline <small>coming soon page with date countdown</small></h3>
<hr />
<div class="row">
    <div class="col-md-12">
        <ul class="timeline">
            <li class="timeline-yellow">
                ...
                <div class="timeline-body">
                    ...
                    <div class="timeline-content">
                        <img class="timeline-img pull-left" src="/themes/jmxtheme/assets/admin/pages/media/blog/2.jpg" alt="">
            ...
            <li class="timeline-blue">
                ...
                <div class="timeline-body">
                    ...
                    <div class="timeline-content">
                        <img class="timeline-img pull-right" src="/themes/jmxtheme/assets/admin/pages/media/blog/1.jpg" alt="">
            ...
            <li class="timeline-green">
                ...
                <div class="timeline-body">
                    ...
                    <div class="timeline-content">
                        <img class="timeline-img pull-left" src="/themes/jmxtheme/assets/admin/pages/media/blog/3.jpg" alt="">
                ...
                <div class="timeline-body">
                    ...
                    <div class="timeline-content">
                        <div class="scroller" data-height="175px" data-always-visible="1" data-rail-visible1="1">
                            <p>
                                <img class="timeline-img pull-right" src="/themes/jmxtheme/assets/admin/pages/media/blog/4.jpg" alt="">
            ...
            <li class="timeline-red">
                ...
                <div class="timeline-body">
                    <h2>Daily Feeds</h2>
                    <div class="timeline-content">
                        <img class="timeline-img pull-left" src="/themes/jmxtheme/assets/admin/pages/media/blog/5.jpg" alt="">
