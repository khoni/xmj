...
<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
    ...
    <div class="col-md-4">
        ...
        <div class="col-sm-8">
	        <?php echo $form->textFieldGroup($kantor,'cabangID',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','readonly'=>'readonly','maxlength'=>50,'onkeypress'=>'return event.charCode <= 57')))); ?> 
        </div>
		<div class="col-sm-4">
        ...
        <div class="note note-success">
            Data Pengguna / Pemilik Sub Agen
        </div>
