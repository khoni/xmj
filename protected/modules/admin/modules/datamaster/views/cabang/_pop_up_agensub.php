            ...
            <div class="modal-body">
                ...
                <div class="note note-success">
                    ...
                    <p>
                         ...
                         <form action="/admin/datamaster/agenSub/addkantor" action="get">
                         	<div class="row">
                ...
                <div class="note note-warning">
                    ...
                    <p><?= CHtml::link('Klik Disini untuk mendaftarkan pengguna baru',array('/admin/datamaster/agenSub/create')) ?></p>
                </div>
            	<!-- end konten -->
            </div>
