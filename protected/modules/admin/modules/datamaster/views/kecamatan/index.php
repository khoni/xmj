...
<h2>Kecamatan<br /><small style="font-size:14px;color:#999999">Manage</small></h2>
<hr />
...
<?php $this->widget('booster.widgets.TbGridView',array(
    ...
    'columns'=>array(
		...
		[
			...
			'value' => function($data){
            	return empty($data->kabupaten->propinsi->negara->nama) ? '-' : $data->kabupaten->propinsi->negara->nama;
            },
		],		
		[
			'name' => 'nama_propinsi',
			...
			//'filter' => CHtml::listData(Role::model()->findAll(),'roleID','nama'),
			'value' => function($data){
            	return empty($data->kabupaten->propinsi->nama) ? '-' : $data->kabupaten->propinsi->nama;
            },
		],		
		[
			'name' => 'nama_kabupaten',
			...
			//'filter' => CHtml::listData(Role::model()->findAll(),'roleID','nama'),
			'value' => function($data){
            	return empty($data->kabupaten->nama) ? '-' : $data->kabupaten->nama;
            },
		],		
