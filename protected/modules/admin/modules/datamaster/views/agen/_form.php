...
<?php //echo $form->errorSummary($user); ?>
    ...
    <div class="col-sm-8">
        <?php echo $form->textFieldGroup($user,'agen_subID',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','readonly'=>'readonly','maxlength'=>50,'onkeypress'=>'return event.charCode <= 57')))); ?> 
    </div>
    <div class="col-sm-4">
