                    ...
                    'columns'=>array(
                        ...
                        [
                            ...
                            'value' => function($data){
								...
								return (empty($data->cabangID) ? '-' : $data->cabangID)."<br /><a class='badge badge-roundless badge-danger' href='#' onClick=\"set_kantor_induk('".$data->kantorID."','$ktr','$kode')\" data-dismiss='modal' aria-hidden='true' >Pilih </a> ";
...
<script>
function set_kantor_induk(kantorID,namaKantor,kodeKantor){
