...
class TbSelect2 extends CInputWidget {
	...
	public function registerClientScript($id) {
		...
		echo $defValue;
                $noSelectId = str_replace("select_", "", $id);
                echo "function formatResult_$id(repo) { var markup = repo.name; return markup;}function formatSelection_$id(repo) {" . 'if(repo.id!=0){$("#' . $noSelectId . '").val(repo.id)}; return repo.name;}';
